...
VARIANTS_RESTAURANT = [
    ...
    Situation: Du hast reserviert (Tisch für Kinderwagen). Man gibt dir einen Hochtisch mitten im Gang.
...
with st.sidebar:
    if st.session_state.intro_complete:
        ...
        difficulty_selection = st.select_slider(
            "Wie hartnäckig ist der Gast/Kunde?",
